...
namespace MarsRover.Core.Utilities.Results
{
    public class TransactionResult
    {
        public bool IsSuccess { get; set; }
        public string Message { get; set; }
        public void SetStatusSucceeded(string messageDescription = null) => SetStatus(true, messageDescription);
        public void SetStatusValidationException(string messageDescription = null) => SetStatus(false, messageDescription);
